...
public final class MyStandardJsonAdapters {
    ...
    public static final JsonAdapter.Factory FACTORY = new JsonAdapter.Factory() {
        @Override public JsonAdapter<?> create(
            ...
            if (type == Object.class) return new MyStandardJsonAdapters.ObjectJsonAdapter(moshi).nullSafe();
            ...
            if (rawType.isEnum()) {
                ...
                return new MyStandardJsonAdapters.EnumJsonAdapter<>((Class<? extends Enum>) rawType).nullSafe();
            }
            return null;
        }
    };
